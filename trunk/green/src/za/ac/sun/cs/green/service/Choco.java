...
public class Choco extends AbstractService {
	...
	private CPSolver chocoSolver = null;
	...
	private void solve(Expression expression) {
		...
		variableMap = new HashMap<Variable, IntegerVariable>();
		try {
			new Translator(chocoModel, variableMap).translate(expression);
